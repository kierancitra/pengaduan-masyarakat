              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Aplikasi Pengaduan Masyarakat Desa Goa Boma! Login Sebagai Admin / Petugas</h1>
                  </div>
                  <form class="user" method ="post" action="src-login2.php">
                    ...
                    <a href="login.php" class="btn btn-success btn-user btn-block">
                      <i class="fab fab-laptop fa-fw"></i> Kembali ke Login Masyarakat</a>
                  </form>
                  <hr>
              </div>
            </div>
